    ...
    script.onload = function() {
        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            function updateCalculator() {
                ...
                studyPeriodValue.textContent = `${appState.calculator.studyPeriod} 年`;
            ...
            function updateChartData(SP, RP) {
                ...
                // 還款期間 (Repayment Period)
                // Calculate the fixed monthly principal and interest components
